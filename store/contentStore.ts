...
export const DEFAULT_CONTENT: CMSContent = {
  ...
  homepage: {
    headline: "Hi, I'm Jai.",
    subheadline: "I design digital experiences, websites and products that solve real problems.",
    question: "What would you like to know?",
    footerNote: "Available for opportunities",
    cards: {
      work: { question: "Can you solve our design problems?", description: "Explore projects, case studies and outcomes." },
      recruit: { question: "Are you the right person for this role?", description: "Skills, experience, qualifications and career history." },
      process: { question: "How do you approach UX and product design?", description: "Research, strategy, testing and design thinking." },
      story: { question: "What's your story?", description: "The journey, interests and multidisciplinary background behind the designer." },
    },
  },
  work: {
    heroStatement: "Here are the projects that demonstrate how I solve complex design challenges.",
    caseStudies: [
      ...
      {"id": 8, "title": "Pitchford Farms — Website Rebuild", "client": "Pitchford Farms", "summary": "A full website rebuild for Pitchford Farms, a South Australian family-owned cattle operation selling premium grass-fed beef direct to consumers. The project involved redesigning and rebuilding their site on a custom CMS, writing all website copy, and setting up PayPal e-commerce for quarter and half side beef pack orders.", "outcomes": ["Rebuilt and launched a full e-commerce website on a custom CMS", "Wrote all website copy from scratch including product descriptions, FAQs, and terms and conditions", "Structured product pages to clearly communicate the difference between quarter and half side beef packs", "Integrated PayPal checkout for direct online ordering", "Delivered CMS training so the client can self-manage the site", "Improved customer clarity around ordering, customisation, delivery, and food safety"], "tags": ["Website Rebuild", "E-Commerce", "Copywriting", "Agriculture", "Food & Beverage", "PayPal Integration"], "status": "published", "updatedAt": "2026-08-26T11:18:41.165Z", "coverImageUrl": "/imports/projects/JABA/Pitchford-Farms/pichford-farms-cover-image.jpg", "heroImageUrl": "/imports/projects/JABA/Pitchford-Farms/pitchford-farms-homepage.jpg", "img1Url": "/imports/projects/JABA/Pitchford-Farms/pichford-farms-hightlight-image-1-.jpg", "img2Url": "/imports/projects/JABA/Pitchford-Farms/pichford-farms-hightlight-image-2-.jpg", "img3Url": "/imports/projects/JABA/Pitchford-Farms/pichford-farms-hightlight-image-3-.jpg", "liveUrl": "https://pitchfordfarms.com.au/", "fullContent": "<p>Pitchford Farms needed a website that could do more than look good. They sell beef in bulk directly from the farm, which means their customers need clear information before they commit to a purchase. The old site wasn't communicating their offering well enough, and the ordering process wasn't working for them.</p><p>The rebuild started with understanding how their products actually work. Quarter and half side packs are quite different in terms of weight, price, and customisation options, and that distinction wasn't landing clearly with customers. I restructured the content and rewrote all copy to make the pack options easy to understand at a glance, including what customisation is available, how ordering and payment works, and what to expect around delivery and storage.</p><p>The site was built on our custom JABA CMS, with more complex development elements handed off to a developer. E-commerce was set up through PayPal, giving customers a straightforward way to pay for orders directly on the site.</p><p>Policy and FAQ content was also developed from scratch, covering areas like food safety, refunds, storage responsibilities, and delivery, written in plain language that reflects the farm's direct and honest approach.</p><p>After launch, a CMS training session was provided so the client could confidently manage and update the site independently going forward.</p>", "clientMode": "agency", "companyId": "company-1785500629780", "slug": "pitchford-farms", "hideScrollIndicator": false},
    ...
    projects: [
      ...
      {"id": "ct-filtration", "num": "06", "name": "CT Filtration", "client": "CT Filtration · Adelaide", "tags": ["Web Design", "UX Design", "JABA CMS V6", "Photoshop"], "desc": "Website design for Adelaide's whole-house water filtration specialist — image-enhanced navigation, a dedicated Benefits page as a top-level marketing tool, 3D product walkthrough video, and Google Reviews integration.", "outcomes": ["Image-enhanced navigation for faster product recognition", "Benefits page given top-level placement as a key conversion tool", "3D product walkthrough video to support informed buying decisions", "Google Reviews integration for social proof and credibility"], "imgs": ["/imports/projects/JABA/ct-filtration/ct-filtration-hightlight-image.jpg", "/imports/projects/JABA/ct-filtration/ct-filtration-hightlight-image-3-.jpg", "/imports/projects/JABA/ct-filtration/ct-filtration-hightlight-image-2-.jpg", "/imports/projects/JABA/ct-filtration/ct-filtration-hero-image.jpg", "", ""], "live": null, "caseStudy": null, "coverImageUrl": "/imports/projects/JABA/ct-filtration/ct-filtration-cover-images.jpg", "heroImageUrl": "/imports/projects/JABA/ct-filtration/ct-filtration-hero-image.jpg", "img1Position": "48% 56%", "img2Position": "46% 44%", "status": "published", "updatedAt": "2026-08-25T09:55:52.690Z", "clientMode": "agency", "companyId": "company-1785500629780"},
      ...
      {"id": "alliance-metal", "num": "09", "name": "Alliance Metal", "client": "Alliance Metal", "tags": ["Web Design", "UX Design", "SEO", "JABA CMS V6"], "desc": "Website revamp for an Australian industrial fabrication company, region-specific SEO landing pages, Industries Served navigation, project case study blogs, and individual service pages.", "outcomes": ["4 region-specific landing pages targeting local search queries", "Industries Served section showcasing cross-sector expertise", "Project blog driving SEO through in-depth case studies", "Individual service pages for clear, organised information"], "imgs": ["/imports/projects/JABA/alliance-metal/Alliance-Metal-Hightlight-2.jpg", "/imports/projects/JABA/alliance-metal/Alliance-Metal-Hightlight-2.jpg", "/imports/projects/JABA/alliance-metal/Alliance-Metal-Hightlight-1.jpg", "/imports/projects/JABA/alliance-metal/Alliance-Metal-Hightlight-3.jpg", "", ""], "live": "https://www.alliancemetal.com.au", "caseStudy": null, "heroImageUrl": "/imports/projects/JABA/alliance-metal/Alliance-Metal-Hero-Image.jpg", "status": "published", "updatedAt": "2026-08-25T09:51:36.977Z", "coverImageUrl": "/imports/projects/JABA/alliance-metal/Alliance-Metal-Cover-Image4.jpg", "clientMode": "agency", "companyId": "company-1785500629780", "img3Position": "50% 52%", "img1Position": "49% 54%"},
    ],
    ...
    projectListColumns: 4,
    projectListRows: 3,
  },
  evaluate: {
    heroStatement: "Everything you need to evaluate me as a candidate – from experience and qualifications to the projects, processes and multidisciplinary skills I bring to a team.",
    ...
    experience: [
      { org: "JABA Web Design", period: "2023 – Present", role: "Web Designer, Project Manager & Office Manager", highlights: ["Designed and delivered custom websites using the JABA CMS platform.", "Developed Progressive Web Apps for improved user experiences across devices.", "Managed projects from concept through delivery.", "Coordinated communication between stakeholders, developers and clients.", "Supported office operations and team culture.", "Contributed to business growth through design and strategic thinking."], tags: ["UX Design", "Web Design", "App Design", "AI Development", "Project Management", "Stakeholder Management"] },
      { org: "Us 2 Travel Moments", period: "2017 – 2022", role: "Digital Designer & Content Creator", highlights: ["Designed and developed WordPress websites.", "Managed multiple Shopify stores.", "Produced photography and video content.", "Grew digital audiences through content strategy.", "Implemented SEO and analytics tracking.", "Managed customer-facing online experiences."], tags: ["Web Design", "Digital Marketing", "Content Strategy", "E-Commerce"] },
      { org: "Alfa Vital", period: "2020 – 2021", role: "Design Lead", highlights: ["Led design and development of innovative agricultural processing systems.", "Achieved 400% efficiency improvements and 40% increased yield.", "Designed the complete processing plant workflow.", "Managed branding, product packaging and construction coordination.", "Delivered large-scale multidisciplinary projects."], tags: ["Industrial Design", "Project Management", "Leadership", "Systems Thinking"] },
      { org: "Annosky", period: "2015 – 2017", role: "UX/UI Designer", highlights: ["Designed interfaces for internal software products.", "Conducted usability testing with more than 500 students.", "Developed user personas and testing frameworks.", "Produced prototypes, graphics, video and motion design.", "Collaborated closely with developers and product teams."], tags: ["UX Research", "UI Design", "User Testing", "Prototyping"] },
    ],
    qualifications: [
      { title: "Bachelor of Communication & Multimedia Design", org: null, major: "Creative Technology", minor: "Meaningful Data Design" },
      { title: "Professional Diploma in UX Design", org: "UX Design Institute – Credit-Rated by Glasgow Caledonian University" },
      { title: "Advanced Diploma of Digital Marketing", org: "International House Business College Adelaide" },
      { title: "Diploma of Project Management", org: "Southern Cross Education Institute Adelaide" },
    ],
    additional: ["Sport & Exercise Coordination", "Outdoor Sports", "Water Sports", "PADI Rescue Diver"],
    testimonials: [
      { name: "Benjamin Simmer", quote: "Jai's core strength is being able to focus on the smallest of details while still maintaining a clear overview of any design-related challenge.", highlights: ["Detail-oriented", "Strategic thinker", "Problem solver"] },
      { name: "Donny Verduijn", quote: "I know Jai as a hard-working person, a reliable team player and an important pivot within multidisciplinary teams.", highlights: ["Reliable", "Collaborative", "Hands-on"] },
    ],
    beyondDesign: "When I'm not designing, you'll usually find me kitesurfing, spearfishing, exploring the outdoors or staying active through fitness. These activities help me maintain creativity, curiosity and a problem-solving mindset that I bring into my professional work.",
    ctaHeading: "Interested in working together?",
    ctaBody: "Whether you're hiring for a UX/UI Designer, Product Designer, Web Designer or multidisciplinary digital role, I'd love to hear about the opportunity.",
  },
  process: {
    heroStatement: "Design is more than creating screens.",
    steps: [
      { id: "problem", title: "Problem", tagline: "Understand before you act", description: "Great design starts with the right question. I invest time framing the problem space – talking to stakeholders, reviewing existing data, and identifying what success actually looks like. This prevents solving the wrong problem beautifully.", activities: ["Stakeholder interviews", "Problem statement workshops", "OKR alignment", "Constraint mapping"], example: "On the Evolve Car Rental app, the brief was to design a smoother booking flow. Early discovery revealed the real problem was trust – renters hesitated not because the flow was complex, but because they weren't sure what they'd actually be charged and when. Reframing the problem around transparency, not just usability, changed the direction of the whole flow." },
      { id: "research", title: "Research", tagline: "Evidence, not assumptions", description: "I blend generative and evaluative research methods based on what we need to learn. Contextual inquiry, diary studies, competitive analysis, and analytics review all serve different questions. I document findings in ways that actually get used.", activities: ["User interviews", "Contextual inquiry", "Competitive analysis", "Analytics review", "Surveys"], example: "For the healthcare portal, I ran 14 usability sessions across 3 user segments. A consistent finding – patients couldn't locate test results – was invisible in analytics data but appeared in 11 of 14 sessions." },
      { id: "insights", title: "Insights", tagline: "Pattern from noise", description: "Raw data isn't insight. I synthesise research into themes, prioritise by impact and confidence, and translate findings into design directions the whole team can act on. I use affinity mapping, opportunity trees, and Jobs to Be Done frameworks.", activities: ["Affinity mapping", "Opportunity trees", "JTBD analysis", "How Might We generation", "Insight prioritisation"], example: "After 30+ interviews for the B2B SaaS project, synthesis revealed 3 core jobs users were hiring the tool to do. Only one was being served well. This focused the design system work on the right interaction patterns." },
      { id: "strategy", title: "Strategy", tagline: "Set direction before you diverge", description: "Before sketching screens, I define the design strategy: information architecture, key user flows, and interaction principles. This gives the team a shared direction and prevents late-stage rework when someone wants to go a different way.", activities: ["Information architecture", "User flow mapping", "Design principles", "Feature prioritisation", "IA testing"], example: "The patient portal IA was restructured around mental models uncovered in research. We used card sorting with 28 participants to validate the new taxonomy before a single wireframe was built." },
  ...
  story: {
    ...
    timeline: [
      { year: "2016", title: "Started in Project Management", body: "Joined a SaaS startup as a project manager. Watched designers work and thought: I want to do that. Started evening courses in UX while coordinating product delivery.", tag: "Origin" },
      { year: "2018", title: "Moved into Marketing", body: "Took a role running digital for a mid-size marketing group. Learned about audiences, messages and conversion. Grew frustrated with campaigns that didn't consider the people clicking the ads. Started advocating for user research.", tag: "Marketing Chapter" },
      { year: "2020", title: "Transitioned fully into UX", body: "Joined Studio Meridian as a UX designer. First professional design role – steep learning curve, fast growth. Delivered 8 client projects in 2 years. Learned how to advocate for research in organisations that didn't value it yet.", tag: "Design Career Begins" },
      { year: "2022", title: "Senior designer, in-house product", body: "Moved to Velo Financial – first in-house product role. Built the design system from scratch, led design across multiple squads, and started mentoring junior designers.", tag: "Product Design" },
      { year: "Now", title: "Multidisciplinary, on purpose", body: "I don't see my background in marketing, project management and technology as a winding road – I see it as an asset. I bring commercial thinking, delivery experience and a genuine curiosity about technology to every design problem.", tag: "Present" },
    ],
    interests: [
      { label: "Kitesurfing", detail: "One of the best ways to clear the mind and stay physically active." },
      { label: "Spearfishing", detail: "Patience, precision and presence – a sport that mirrors good design thinking." },
      { label: "Creative Technology", detail: "Exploring the intersection of design, code and physical experiences." },
      { label: "Architecture", detail: "Particularly the relationship between space and how people feel and move through it." },
      { label: "Running", detail: "Half marathons. Slower than I'd like, more consistent than I expected." },
    ],
    closingQuote: "The best designers I've met all seem to have one thing in common – they're more curious about people than they are about pixels.",
  },
  enquiries: [],
  mediaMeta: {
...
export function getPublishedProjectBySlug(content: CMSContent, slug: string): CMSProject | undefined {
  ...
  const project = pool.find((p) => projectUrlSlug(p) === slug);
  if (!project || (project.status && project.status !== "published")) return undefined;
  return enrichProjectWithCaseStudy(project, content.work.caseStudies);
}
