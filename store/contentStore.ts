...
export interface CMSCaseStudy {
  ...
  // Section 1 ("Project Detail" in the CMS). Public heading defaults to "Project Detail" when
  // section1Heading is unset.
  fullContent?: string;
  fullContentMobile?: string;
  fullCaseStudyLocked?: boolean;
  fullCaseStudyPassword?: string;
  fullCaseStudyBannerUrl?: string;
  // Section 2 ("Project section 2" in the CMS — field name kept as fullCaseStudyContent to avoid
  // migrating existing content). Public heading defaults to "Process" when section2Heading is
  // unset.
  fullCaseStudyContent?: string;
  fullCaseStudyContentMobile?: string;
  // Section 3 ("Project section 3" in the CMS) — brand new, no legacy field to reuse. No heading
  // fallback: blank section3Heading renders no heading at all, not just a generic default.
  section3Content?: string;
  section3ContentMobile?: string;
  section1Heading?: string;
  section2Heading?: string;
  section3Heading?: string;
  // Small "Role" info-card grid on the project page. All optional/freeform — the section itself
  // is hidden unless at least one of these three is set (the fourth card, Client, always has a
  // value already via the `client` field above).
  ...
  // Colour-overlay gradient on top of the hero banner — same HeroOverlayData shape/semantics
  // shared with the Work/Evaluate/Story/Process page heroes (see HeroOverlayFields.tsx), so a
  // project's banner gets the same customizable tint + live preview those already have.
...
function caseStudyToProject(cs: CMSCaseStudy): CMSProject {
  return {
    ...
    heroOverlayEnabled: cs.heroOverlayEnabled,
    heroOverlayColor1: cs.heroOverlayColor1,
    heroOverlayColor1Opacity: cs.heroOverlayColor1Opacity,
    heroOverlayColor2: cs.heroOverlayColor2,
    heroOverlayColor2Opacity: cs.heroOverlayColor2Opacity,
    heroOverlayColor2Transparent: cs.heroOverlayColor2Transparent,
    heroOverlayRatio: cs.heroOverlayRatio,
    heroOverlayDirection: cs.heroOverlayDirection,
    heroOverlayMidpoint: cs.heroOverlayMidpoint,
    ...
    section3Content: cs.section3Content,
    section3ContentMobile: cs.section3ContentMobile,
    section1Heading: cs.section1Heading,
    section2Heading: cs.section2Heading,
    section3Heading: cs.section3Heading,
    fullCaseStudyRole: cs.fullCaseStudyRole,
    fullCaseStudyPlatform: cs.fullCaseStudyPlatform,
    fullCaseStudyScope: cs.fullCaseStudyScope,
    fullCaseStudyLocked: cs.fullCaseStudyLocked,
    status: cs.status,
...
export function enrichProjectWithCaseStudy(project: CMSProject, caseStudies: CMSCaseStudy[]): CMSProject {
  ...
  return {
    ...
    heroOverlayEnabled: project.heroOverlayEnabled ?? cs.heroOverlayEnabled,
    heroOverlayColor1: cs.heroOverlayColor1 || project.heroOverlayColor1 || undefined,
    heroOverlayColor1Opacity: cs.heroOverlayColor1Opacity ?? project.heroOverlayColor1Opacity,
    heroOverlayColor2: cs.heroOverlayColor2 || project.heroOverlayColor2 || undefined,
    heroOverlayColor2Opacity: cs.heroOverlayColor2Opacity ?? project.heroOverlayColor2Opacity,
    heroOverlayColor2Transparent: cs.heroOverlayColor2Transparent ?? project.heroOverlayColor2Transparent,
    heroOverlayRatio: cs.heroOverlayRatio ?? project.heroOverlayRatio,
    heroOverlayDirection: cs.heroOverlayDirection ?? project.heroOverlayDirection,
    heroOverlayMidpoint: cs.heroOverlayMidpoint ?? project.heroOverlayMidpoint,
    ...
    section3Content: project.section3Content || cs.section3Content || undefined,
    section3ContentMobile: project.section3ContentMobile || cs.section3ContentMobile || undefined,
    section1Heading: project.section1Heading || cs.section1Heading || undefined,
    section2Heading: project.section2Heading || cs.section2Heading || undefined,
    section3Heading: project.section3Heading || cs.section3Heading || undefined,
